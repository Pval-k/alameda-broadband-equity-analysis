...
- Mean, median, standard deviation, and IQR of measured speeds across ZCTAs

#### 2. Income vs Speed Relationship
- Pearson correlation between median income and download speed
- Scatter plot with regression line

#### 3. Urbanicity Analysis
- ZCTAs grouped into low, medium, and high population density
- One-way ANOVA used to test differences in speeds

#### 4. Advertised vs Actual Speeds
- Performance ratio calculated:
  \[
  \text{Performance Ratio} = \frac{\text{Measured Download Speed}}{\text{Advertised Speed}}
  \]
